const egma_math_url = 'http://localhost:8080/?task=egma-math';

describe('Egma-math Complete Run', () => {
  ...
  it('runs complete egma-math with screenshots', () => {
    // Visit with fullscreen mocking and extended timeout
    cy.visit(egma_math_url, {
      timeout: 60000,
      onBeforeLoad: (win) => {
