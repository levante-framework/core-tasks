describe('TROG Test with Fullscreen Mock and Screenshots', () => {
  ...
  function takeScreenshot(name) {
    if (Cypress.env('takeScreenshots')) {
      ...
      cy.screenshot(`${paddedCounter}_trog_${name}`, { 
        capture: 'viewport',
        overwrite: true 
      });
    }
  ...
  it('TROG test with fullscreen mocking and comprehensive screenshots', () => {
    const trogUrl = 'http://localhost:8080/?task=trog';
